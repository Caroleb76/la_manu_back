...
-- AddForeignKey
ALTER TABLE "Users" ADD CONSTRAINT "Users_adressId_fkey" FOREIGN KEY ("adressId") REFERENCES "Address"("id") ON DELETE SET NULL ON UPDATE CASCADE;
